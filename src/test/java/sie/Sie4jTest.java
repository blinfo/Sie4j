...
public class Sie4jTest {
    ...
    public void test_file_with_missing_account_balance() {
        ...
        long numberOfLogs = 2;
        String level = SieLog.Level.CRITICAL.name();
        String message = "Strängen '' för balans, konto 1119, kan inte hanteras som belopp: #IB 0 1119 \"\"";
    ...
    public void test_too_long_account_number() {
        ...
        String error = "SieLogDTO{level=CRITICAL, message=Kontot är längre än sex siffror: 11100111, tag=#KONTO, origin=DocumentFactory, line=#KONTO 11100111 \"Byggnader\"}";
